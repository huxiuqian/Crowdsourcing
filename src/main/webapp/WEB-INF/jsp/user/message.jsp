...
<%@ page import="com.erzu.zhongbao.pojo.*" %>
...
<html>
     ...
     function getMsg(){
    	 ...
    	 $.ajax({
    		 ...
    		 success:function(data){
    			/*  alert("success"); */
    			$(".sender").text(data.bussinessname);
    			$(".smtime").text(data.msgtime);//href="User/replymsg
    			$(".sminfo").text(data.msgcontents);
    			$(".tiao").text("回复");
    			$(".tiao").attr("href","User/replymsg?bussinessid="+data.bussinessid+"&realname="+data.bussinessname);
    		 }
    	 });
     }
     </script>
    ...
    <body>
		...
		<div class="row">
			...
			<div class="col-sm-6 realname"><%=name%></div>
		</div>
		<%-- --%>
		<div class="row">
